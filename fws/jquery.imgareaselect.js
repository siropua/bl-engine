...
jQuery.imgAreaSelect = function (img, options) {
    ...
    $a.css({ display: 'none', position: 'absolute', lineHeight: '0px', fontSize: '0px' });    
    ...
    jQuery(img).mousedown(function (event) {
        ...
        $a.show().css({ width: '0px', height: '0px', left: x1, top: y1 });
        ...
        jQuery(document).one('mouseup', function () {
            ...
            if(selection.x2 - selection.x1 < 50)selectingMouseMove(event);
